...
The root `AGENTS.md` is the repository's normative control plane. Its rules apply before deeper lookup. Design Kit is the optional `@hraness/design-kit` package for stable presentation compositions built above Hraness UI.
