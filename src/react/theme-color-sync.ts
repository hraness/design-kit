export const themeColorSyncActiveAttribute =
  "data-hraness-design-theme-color-sync-active";
export const themeColorSyncDisabledAttribute =
  "data-hraness-design-theme-color-sync-disabled";
