...
test("relatedFor() items render through ArticleRelatedProducts, MarketingRelated, and the static renderer", () => {
  ...
  for (const item of items) {
    for (const markup of [article, marketing, html]) {
      ...
      expect(markup).toContain(escapeArticleHtml(item.relationship));
    }
  }
});
