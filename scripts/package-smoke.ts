...
function requireDesignKitManifest(
  ...
  assert.deepEqual(
    manifest.package,
    { name: "@hraness/design-kit", version: "0.18.1" },
...
if (uiDevelopmentSpecifier !== "github:hraness/ui#v0.5.17") {
  throw new Error(
    "Design-kit v0.18.1 must build and publish against the immutable @hraness/ui v0.5.17 release.",
  );
}
...
if (uiPeerRange !== ">=0.5.16 <0.6.0") {
  throw new Error("Design-kit v0.18.1 must declare the exact @hraness/ui v0.5 peer range.");
}
