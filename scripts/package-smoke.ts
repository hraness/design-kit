...
if (uiDevelopmentSpecifier !== "github:hraness/ui#v0.5.16") {
  throw new Error(
    "Design-kit v0.11.0 must build and publish against the immutable @hraness/ui v0.5.16 release.",
  );
}
...
if (uiPeerRange !== ">=0.5.16 <0.6.0") {
  throw new Error("Design-kit v0.11.0 must declare the exact @hraness/ui v0.5 peer range.");
}
